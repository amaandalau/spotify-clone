...
var sccope = 'user-read-private user-read-email user-top-read'
...
function authorize() {
    ...
    url += '&scope=' + encodeURIComponent(sccope)
...
function displayNewReleases(data) {
    ...
    var sectionSubtitle = section.querySelector(`.subtitle`)
    var sectionWrapper = section.querySelector(`.card-wrapper`)
    sectionTitle.textContent = "New Releases" // NOT SHOWING
...
function displayFeaturedPlaylists(data) {
    ...
    var sectionSubtitle = section.querySelector(`.subtitle`)
    var sectionWrapper = section.querySelector(`.card-wrapper`)
    sectionTitle.textContent = "Featured Playlists" // NOT SHOWING
